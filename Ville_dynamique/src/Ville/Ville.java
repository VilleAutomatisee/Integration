...
public class Ville
{
    ...
    private void generateurVille()
    {
        ...
        List <Route> listRouteCarrefour = new ArrayList<Route>();

        listRouteCarrefour.add(r8);
        listRouteCarrefour.add(r9);
        listRouteCarrefour.add(r10);
        listRouteCarrefour.add(r11);
        ...
        r6.getSortieEntree().connectRoute( r9.getSortieEntree() );
        r7.getEntreeSortie().connectRoute( r8.getSortieEntree() );




        r9.getSortieEntree().connectRoute( r7.getSortieEntree() );
        r10.getSortieEntree().connectRoute( r8.getEntreeSortie() );
        r11.getSortieEntree().connectRoute( r8.getSortieEntree() );
        ...
        Carrefour c1 = new Carrefour( listRouteCarrefour );
